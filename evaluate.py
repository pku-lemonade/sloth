...
from evaluater.sim_type import Workload, FailSlow
from evaluater.architecture import Arch
...
def main():
    ...
    probe = [args.fragment, args.type, args.location, args.plevel, args.structure]

    arch = Arch(arch_config, [pe.insts for pe in workload.pes], fail_slow, workload.name, args.fail, noc_model, inference_time, probe, stage)
